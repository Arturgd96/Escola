...
class Base(models.Model):
    ...
    data_atualizacao = models.DateTimeField(auto_now=True,
                                            ...
                                            db_comment='Data de atualizacao do objeto',
                                            )

    ativo = models.BooleanField(default=True,
                                db_column='f_____ativo',
                                db_comment='Indicador se objeto ainda esta ativo',
                                )
...
class CursoTrilha(Base):
    ...
    id_curso = models.ForeignKey('Curso', on_delete=models.RESTRICT,
                                 ...
                                 db_comment='Chave de ligacao com a tabela tbcurso',
                                 )

    id_trilha = models.ForeignKey('Trilha', on_delete=models.RESTRICT,
                                  db_column='ctrilhasequencial',
                                  db_comment='Chave de ligacao com a tabela tbtrilha',
                                  )
...
class Curso(Base):
    ...
    descricao = models.TextField(db_column='ecursodescricao',
                                 db_comment='Descricao do curso',
                                 )
    publico_alvo = models.TextField(db_column='ecursopublico',
                                    db_comment='Publico alvo do curso',
                                    )
...
class Turma(Base):
    ...
    professor = models.CharField(max_length=50, blank=False, null=False,
